          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8">
              {cocurricularActivities.map((activity) => (
                <div key={activity.id} className="bg-gray-900 border border-gray-700 p-6 rounded-lg hover:shadow-md hover:border-slate-500/50 transition-all animate-scale-in">
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      ...
                      <p className={`text-slate-400 font-semibold`}>{activity.role}</p>
                    </div>
                  </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div className="bg-gray-800 border border-gray-700 p-6 rounded-lg hover:shadow-lg hover:border-slate-500/50 transition-all animate-scale-in">
                <div className="w-16 h-16 bg-slate-600 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Mail className="text-white text-2xl" />
                </div>
                <h3 className="text-xl font-bold text-white mb-2">Email</h3>
                <p className="text-gray-300">
                  <a href={`mailto:${personalInfo.email}`} className="text-slate-400 hover:text-slate-300 transition-colors">
                    {personalInfo.email}
                  </a>
                </p>
              </div>
              ...
              <div className="bg-gray-800 border border-gray-700 p-6 rounded-lg hover:shadow-lg hover:border-slate-500/50 transition-all animate-scale-in">
                ...
                <p className="text-gray-300">
                  <a href={`tel:+91${personalInfo.phone}`} className="text-slate-400 hover:text-slate-300 transition-colors">
            ...
            <div className="text-center mt-12">
              <Button 
                ...
                size="lg"
                className="inline-flex items-center gap-2 bg-slate-700 text-white px-8 py-4 rounded-lg hover:bg-slate-600 transition-colors text-lg"
              >
