              ...
              {cocurricularActivities.map((activity) => (
                <div key={activity.id} className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow animate-scale-in">
                  <div className="flex items-center mb-4">
                    <div className={`w-12 h-12 bg-${activity.color}-500 rounded-lg flex items-center justify-center mr-4`}>
                      <Users className="text-white" />
                    </div>
                    <div>
                      <h3 className="text-xl font-bold text-slate-800">{activity.title}</h3>
                      <p className={`text-${activity.color}-600 font-semibold`}>{activity.role}</p>
                    </div>
                  </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div className="bg-slate-50 p-6 rounded-lg hover:shadow-lg transition-shadow animate-scale-in">
                ...
                <p className="text-slate-600">
                  <a href={`mailto:${personalInfo.email}`} className="text-primary hover:text-secondary transition-colors">
                    {personalInfo.email}
                  </a>
                </p>
              </div>
              ...
              <div className="bg-slate-50 p-6 rounded-lg hover:shadow-lg transition-shadow animate-scale-in">
                ...
                <p className="text-slate-600">
                  <a href={`tel:+91${personalInfo.phone}`} className="text-primary hover:text-secondary transition-colors">
            ...
            <div className="text-center mt-12">
              <Button 
                ...
                size="lg"
                className="inline-flex items-center gap-2 bg-primary text-white px-8 py-4 rounded-lg hover:bg-secondary transition-colors text-lg"
              >
